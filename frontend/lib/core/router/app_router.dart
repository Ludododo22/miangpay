  ...
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (_, __) => const CountrySelectionScreen()),
      ...
      GoRoute(
          path: '/kyc-address', builder: (_, __) => const KycAddressScreen()),
      GoRoute(
          path: '/kyc-document', builder: (_, __) => const KycDocumentScreen()),
      GoRoute(path: '/kyc-selfie', builder: (_, __) => const KycSelfieScreen()),
      GoRoute(path: '/kyc-review', builder: (_, __) => const KycReviewScreen()),
      GoRoute(
          path: '/kyc-pending', builder: (_, __) => const KycPendingScreen()),
      GoRoute(
          path: '/kyc-rejected', builder: (_, __) => const KycRejectedScreen()),
      GoRoute(
          path: '/dashboard', builder: (_, __) => const MainNavigationScreen()),
      GoRoute(
          path: '/transfer', builder: (_, __) => const TransferTypeScreen()),
      GoRoute(
          path: '/transfer/countries',
          builder: (_, __) => const TransferCountryScreen()),
      GoRoute(
          path: '/transfer/beneficiary',
          builder: (_, __) => const TransferBeneficiaryScreen()),
      GoRoute(
          path: '/transfer/new-beneficiary',
          builder: (_, __) => const NewBeneficiaryScreen()),
      GoRoute(
          path: '/transfer/amount',
          builder: (_, __) => const TransferAmountScreen()),
      GoRoute(
          path: '/transfer/summary',
          builder: (_, __) => const TransferSummaryScreen()),
      GoRoute(
          path: '/transfer/pin', builder: (_, __) => const TransferPinScreen()),
      GoRoute(
          path: '/transfer/processing',
          builder: (_, __) => const TransferProcessingScreen()),
      GoRoute(
          path: '/transfer/success',
          builder: (_, __) => const TransferSuccessScreen()),
      GoRoute(
          path: '/transfer/receipt',
          builder: (_, __) => const TransferReceiptScreen()),
      GoRoute(
          path: '/beneficiaries',
      ...
      GoRoute(
        ...
        builder: (_, state) =>
            HistoryReceiptScreen(reference: state.pathParameters['reference']!),
      ),
      GoRoute(path: '/cards', builder: (_, __) => const CardsScreen()),
      GoRoute(
          path: '/cards/create', builder: (_, __) => const CreateCardScreen()),
      GoRoute(
      ...
      GoRoute(
        path: '/cards/topup/:id',
        builder: (_, state) =>
            TopUpCardScreen(cardId: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/cards/settings/:id',
        builder: (_, state) =>
            CardSettingsScreen(cardId: state.pathParameters['id']!),
      ),
      GoRoute(path: '/loyalty', builder: (_, __) => const LoyaltyScreen()),
      GoRoute(
          path: '/loyalty/tiers',
          builder: (_, __) => const LoyaltyTiersScreen()),
      GoRoute(
          path: '/loyalty/rewards',
          builder: (_, __) => const RewardsStoreScreen()),
      GoRoute(
          path: '/loyalty/challenges',
          builder: (_, __) => const LoyaltyChallengesScreen()),
      GoRoute(
          path: '/loyalty/history',
          builder: (_, __) => const LoyaltyHistoryScreen()),
      GoRoute(
          path: '/loyalty/referral',
          builder: (_, __) => const LoyaltyReferralScreen()),
      GoRoute(
          path: '/promotions', builder: (_, __) => const PromotionsScreen()),
      GoRoute(
        path: '/promotions/detail/:id',
        builder: (_, state) =>
            PromotionDetailScreen(promotionId: state.pathParameters['id']!),
      ),
      GoRoute(
      ...
      GoRoute(
          path: '/promotions/savings',
          builder: (_, __) => const SavingsCenterScreen()),
      GoRoute(
          path: '/notifications',
      ...
      GoRoute(
          ...
          builder: (_, __) => const NotificationSettingsCenterScreen()),
      ...
      GoRoute(
          path: '/profile/mobile-money',
          builder: (_, __) => const MobileMoneyAccountsScreen()),
      GoRoute(
          path: '/profile/devices',
          builder: (_, __) => const ConnectedDevicesScreen()),
      GoRoute(
          path: '/profile/security-log',
          builder: (_, __) => const SecurityLogScreen()),
      GoRoute(
      ...
      GoRoute(
          path: '/system/offline', builder: (_, __) => const OfflineScreen()),
      GoRoute(
          path: '/system/maintenance',
          builder: (_, __) => const MaintenanceScreen()),
      GoRoute(
          path: '/system/server-error',
          builder: (_, __) => const ServerErrorScreen()),
      GoRoute(
          path: '/system/update-required',

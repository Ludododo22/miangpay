...
class _CreateCardScreenState extends ConsumerState<CreateCardScreen> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          const Text('Limite quotidienne',
              style: TextStyle(fontWeight: FontWeight.w900)),
          const SizedBox(height: 12),
          RadioGroup<double>(
            groupValue: _dailyLimit,
            onChanged: (value) =>
                setState(() => _dailyLimit = value ?? _dailyLimit),
            child: Column(
              children: [
                for (final limit in const [100000.0, 250000.0, 500000.0])
                  Container(
                    ...
                    child: RadioListTile<double>(
                      value: limit,
                      title: Text(
                        '${limit.toStringAsFixed(0)} $_currency',
          ...
          CheckboxListTile(
            ...
            title: const Text(
                'J’accepte les conditions d’utilisation de la carte virtuelle.'),
          ),
          const SizedBox(height: 24),
          PrimaryButton(
  ...
  Future<void> _createCard() async {
    ...
    final card = await ref
        ...
        .createCard(currency: _currency, dailyLimit: _dailyLimit);

...
final fakeCardsDatasourceProvider = Provider<FakeCardsDatasource>((ref) => FakeCardsDatasource());
...
final selectedCardProvider = FutureProvider.family<VirtualCardModel?, String>((ref, id) async {

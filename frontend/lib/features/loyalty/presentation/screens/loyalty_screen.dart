    ...
    return Scaffold(
      ...
      body: overview.when(
        ...
        data: (data) => ListView(
          ...
          children: [
            LoyaltyHeaderCard(points: data.points),
              ...
              children: [
                Expanded(
                  child: _ShortcutCard(
                    ...
                    onTap: () => context.push('/loyalty/tiers'),
                  ),
                ),
            ...
            _SectionHeader(
              title: 'Defis actifs',
              action: 'Voir tout',
              onTap: () => context.push('/loyalty/challenges'),
            ),
            ...
            const SizedBox(height: 24),
            _SectionHeader(
              title: 'Recompenses populaires',
              action: 'Boutique',
              onTap: () => context.push('/loyalty/rewards'),
            ),
            const SizedBox(height: 12),
            ...data.rewards.take(2).map((reward) => RewardTile(reward: reward)),
            const SizedBox(height: 24),
            _SectionHeader(

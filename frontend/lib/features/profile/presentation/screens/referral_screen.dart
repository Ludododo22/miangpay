        ...
        children: [
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
              Icon(Icons.card_giftcard_rounded, color: AppColors.accent, size: 40),
              SizedBox(height: 14),
              Text('Invitez vos proches', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900)),
              SizedBox(height: 8),
              Text('Gagnez 500 points pour chaque ami vérifié qui effectue son premier transfert.', style: TextStyle(color: Colors.white70, height: 1.5)),
            ]),
          ),
          ...
          Container(
            ...
            child: Row(children: const [Expanded(child: Text('JEAN2026', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, letterSpacing: 2))), Icon(Icons.copy_rounded, color: AppColors.secondary)]),
          ),
          const SizedBox(height: 20),
          Row(children: const [
          ...
          PrimaryButton(label: 'Partager mon code', icon: Icons.share_rounded, onPressed: () {}),
        ],
      ),
    );
  }

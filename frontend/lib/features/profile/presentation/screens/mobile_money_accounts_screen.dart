    ...
    return Scaffold(
      ...
      body: accounts.when(
        ...
        data: (items) => ListView(
          ...
          children: [
            const Text(
                'Associez plusieurs comptes Mobile Money pour transférer plus rapidement selon le pays et l’opérateur.',
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                        child: Column(
                            ...
                            children: [
                          Text(account.operatorName,
                              style:
                                  const TextStyle(fontWeight: FontWeight.w900)),
                          const SizedBox(height: 4),
                          Text('${account.country} • ${account.phone}',
                    ...
                    if (account.primary)
                      const StatusBadge(
                          label: 'Principal', status: AppStatus.success),
                  ]),
                )),
            ...
            PrimaryButton(
              ...
              onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Ajout de compte initialisé'))),
            ),
          ],
        ),
      ),
